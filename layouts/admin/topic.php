        ...
        <div class="col l-12">
            ...
            <div class="row">
                <div class="col l-10 l-o-1">
                    <form method="POST" id="update_topic" enctype="multipart/form-data">
                        ...
                        <div class='form_group'>
                            <label for='name_topic_update'>Tên chủ đề:</label>
                            <input type='text' id='name_topic_update' placeholder='Nhập vào tên chủ đề ...' name='name_topic_update' required minlength='5'>
                        </div>

                        <div class='form_group'>
                            <label for='note_topic_update'>Miêu tả chi tiết:</label>
                            <input type='text' id='note_topic_update' placeholder='Nhập vào miêu tả chi tiết của chủ đề...' name='note_topic_update' required minlength='5'>
                        </div>
...
<div class="row">
    <div class="col l-8">
        <div class="search">
            <p>Tìm kiếm: <input type="text" id="search" onkeyup="search('search','table_theme',2);" placeholder="Tìm kiếm theo chủ đề" title="Tìm kiếm" /></p>
        </div>
    </div>
    <div class="col l-4">
        <div class="number">
